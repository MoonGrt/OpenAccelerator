...
//  * LeNet-5 CNN Network
//  */
// class LeNet5[T <: Data](dataType: HardType[T], config: LeNet5Config) extends Component {
//   import config._
...
//   // ============================================================================
//   val conv1_outputs = Vec(Stream(UInt(dataWidth bits)), 6)
...
//   for (i <- 0 until 6) {
//     val conv1 = new Conv2D3x3(dataType, conv1_config)
//     conv1.io.EN := io.EN
...
//   // ============================================================================
//   val conv1_relu_outputs = Vec(Stream(UInt(dataWidth bits)), 6)
...
//   for (i <- 0 until 6) {
//     val relu1 = new ReLU(dataType, relu_config)
//     relu1.io.EN := io.EN
...
//   // ============================================================================
//   val pool1_outputs = Vec(Stream(UInt(dataWidth bits)), 6)
...
//   for (i <- 0 until 6) {
//     val pool1 = new MaxPooling2x2(dataType, pool1_config)
//     pool1.io.EN := io.EN
...
//   // ============================================================================
//   val conv2_outputs = Vec(Stream(UInt(dataWidth bits)), 12)
...
//   for (i <- 0 until 12) {
//     val conv2 = new Conv2D3x3(dataType, conv2_config)
//     conv2.io.EN := io.EN
...
//   // ============================================================================
//   val conv2_relu_outputs = Vec(Stream(UInt(dataWidth bits)), 12)

//   for (i <- 0 until 12) {
//     val relu2 = new ReLU(dataType, relu_config)
//     relu2.io.EN := io.EN
...
//   // ============================================================================
//   val pool2_outputs = Vec(Stream(UInt(dataWidth bits)), 12)
...
//   for (i <- 0 until 12) {
//     val pool2 = new MaxPooling2x2(dataType, pool2_config)
//     pool2.io.EN := io.EN
...
//   // ============================================================================
//   val flatten_output = Stream(Vec(UInt(dataWidth bits), 192))

//   // Flatten logic: collect all 12 channels of 4x4 = 192 values
//   val flatten_valid = Reg(Bool()) init(False)
//   val flatten_data = Reg(Vec(UInt(dataWidth bits), 192))
...
//  */
// class SimpleLeNet5[T <: Data](dataType: HardType[T], config: LeNet5Config) extends Component {
//   import config._
...
//   // ============================================================================
//   val gaussianKernel = Seq(1,2,1, 2,4,2, 1,2,1) // Using 3x3 for simplicity
//   val conv1_config = Conv2DConfig(
//     dataWidth = dataWidth,
//     convWidth = dataWidth,
//     lineLength = inputSize,
...
//   // ============================================================================
//   val flatten_output = Stream(Vec(UInt(dataWidth bits), 16))

//   // Simplified flattening - collect 4x4 values
//   val flatten_valid = Reg(Bool()) init(False)
//   val flatten_data = Reg(Vec(UInt(dataWidth bits), 16))
...
//     println("Conv1: 5×5 convolution → 24×24")
//     println("ReLU1: Activation")
//     println("Pool1: 2×2 max pooling → 12×12")
//     println("Conv2: 5×5 convolution → 8×8")
//     println("ReLU2: Activation")
//     println("Pool2: 2×2 max pooling → 4×4")
//     println("Flatten: 4×4 → 16")
